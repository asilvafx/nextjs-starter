            ...
            <Body style={emailStyles.main}>
                <Container style={emailStyles.container}>
                    ...
                    <Text style={emailStyles.paragraph}>
                        Une nouvelle commande vient d'être passée sur votre boutique. Voici tous les détails pour
                    ...
                    <Section style={emailStyles.featuresSection}>
                        ...
                        <div style={emailStyles.orderDetailItem}>
                            ...
                            <span style={{ color: '#059669', fontWeight: 'bold', fontSize: '18px' }}>{total}€</span>
                        </div>
                        <div style={emailStyles.orderDetailItem}>
                        ...
                        {items.map((item, index) => (
                            <div
                                ...
                                <div style={{ fontSize: '14px', color: '#6B7280' }}>
                                    Taille: {item.size || 'N/A'} | Quantité: {item.quantity} | Prix unitaire:{' '}
                                    {item.price}€
                                </div>
                    ...
                    <Section
                        ...
                        <div style={emailStyles.orderDetailItem}>1. ✅ Vérifier la disponibilité des produits</div>
                        <div style={emailStyles.orderDetailItem}>2. 📦 Préparer le colis</div>
                        <div style={emailStyles.orderDetailItem}>3. 🏷️ Imprimer l'étiquette d'expédition</div>
                        <div style={emailStyles.orderDetailItem}>4. 📧 Envoyer le numéro de suivi au client</div>
                    </Section>
                    ...
                    <Section style={emailStyles.supportSection}>
                        <Text style={emailStyles.supportText}>
                            Cet email a été envoyé à l'équipe administrative.
                            <br />
