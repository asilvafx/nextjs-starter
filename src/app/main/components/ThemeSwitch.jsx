...
const ThemeSwitch = () => {
    ...
    return (
        <div className="w-fit">
            <div className="flex w-auto flex-row justify-center overflow-hidden rounded-md border border-neutral-200 dark:border-neutral-700 sm:flex-row">
                {SWITCH_DATA.map((data) => (
                    <button
                        key={data.value}
                        className={`flex items-center gap-2 px-4 py-2 text-sm text-black dark:text-white ${
