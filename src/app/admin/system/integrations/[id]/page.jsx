      ...
      <div className="container mx-auto p-6">
        <Card>
          <CardContent className="text-center py-12">
            ...
            <Button onClick={() => router.push('/admin/system/integrations')}>
    ...
    <div className="container mx-auto p-6">
      <div className="flex items-center gap-4 mb-8">
        <Button
          variant="outline"
          size="sm"
          onClick={() => router.push('/admin/system/integrations')}
        >
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {integration.enabled ? 'Integration is currently active' : 'Integration is currently inactive'}
                  </p>
                </div>
                <Switch
