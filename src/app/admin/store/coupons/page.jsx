...
export default function CouponsPage() {
    ...
    const getCouponStatus = (coupon) => {
        ...
        if (coupon.usageType !== 'unlimited' && coupon.usedCount >= coupon.usageLimit)
        ...
        <div className="space-y-4">
            <div className="space-y-4">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="font-semibold text-2xl">Coupons & Promo Codes</h2>
                                                ...
                                                <Select
                                                    ...
                                                    onValueChange={(value) =>
                                                        setFormData((prev) => ({
                                                            ...prev,
                                                            targetType: value,
                                                            targetEmail: value === 'public' ? '' : prev.targetEmail
                                                        }))
                                                    }>
                                                    <SelectTrigger>
                                                        <SelectValue />
                        ...
                        <div className="grid gap-4 py-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    min={new Date().toISOString().split('T')[0]}
                                />
                                <p className="text-muted-foreground text-sm">Leave empty for no expiration</p>
                            </div>
                        ...
                        <div className="grid gap-4 py-4">
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-muted-foreground text-sm">{selectedCoupon.name}</p>
                                </div>
                            </div>
                            ...
                            {selectedCoupon.description && (
                                <div>
                                    ...
                                    <p className="mt-1 text-muted-foreground text-sm">{selectedCoupon.description}</p>
                                </div>
                            )}
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="mt-1 text-muted-foreground text-sm">
                                        ...
                                        {selectedCoupon.type === 'percentage' ? 'off' : 'discount'}
                                    </p>
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <Label className="font-medium text-sm">Min Amount</Label>
                                    <p className="mt-1 text-muted-foreground text-sm">
                                        {selectedCoupon.minAmount > 0 ? `€${selectedCoupon.minAmount}` : 'No minimum'}
                                    </p>
                                </div>
                                <div>
                                    <Label className="font-medium text-sm">Max Amount</Label>
                                    <p className="mt-1 text-muted-foreground text-sm">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <Label className="font-medium text-sm">Usage</Label>
                                    <p className="mt-1 text-muted-foreground text-sm">
