            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                    ...
                    <Select
                        ...
                        onValueChange={(value) => setUserProfile({ ...userProfile, country: value })}>
                        <SelectTrigger>
                    ...
                    <div className="space-y-4">
                        ...
                        {backupCodes.length > 0 && (
                            <div className="space-y-2">
                                ...
                                <div className="grid grid-cols-2 gap-2 rounded bg-muted p-3">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            ...
                            <p className="text-muted-foreground text-sm">Special deals and promotional notifications</p>
                        </div>
                        <Switch
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <p className="font-medium">Security Alerts</p>
                            <p className="text-muted-foreground text-sm">Important security notifications via email</p>
                        </div>
                        <Switch
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <p className="font-medium">System Updates</p>
                            <p className="text-muted-foreground text-sm">System maintenance and update notifications</p>
                        </div>
                        <Switch
            ...
            <Card>
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <p className="font-medium">Security Alerts</p>
                            <p className="text-muted-foreground text-sm">Critical security notifications via SMS</p>
                        </div>
                        <Switch
                    ...
                    <div className="flex items-center justify-between">
                        <div className="space-y-1">
                            <p className="font-medium">System Updates</p>
                            <p className="text-muted-foreground text-sm">System maintenance notifications via SMS</p>
                        </div>
                        <Switch
