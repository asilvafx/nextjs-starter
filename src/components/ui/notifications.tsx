...
export function NotificationsPopover() {
    ...
    return (
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            <PopoverContent className="w-80 p-0" side="bottom" align="end" sideOffset={5}>
                        ...
                        <div className="divide-y">
                            {notifications.map((notification) => (
                                <div
                                    key={notification.id}
                                    className={cn(
                                        'flex cursor-pointer flex-col gap-1 p-4 hover:bg-accent',
                                    ...
                                    <p className="line-clamp-2 text-muted-foreground text-sm">{notification.message}</p>
                                </div>
                            ))}
                        </div>
                    )}
