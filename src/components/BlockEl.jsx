        ...
        case 'html':
            return (
                <div className="html-block">
                    {/* Custom CSS */}
                    {block.data?.css && (
                        <style dangerouslySetInnerHTML={{ __html: block.data.css }} />
                    )}
                    ...
                    {/* Custom JavaScript */}
                    {block.data?.js && (
                        <script dangerouslySetInnerHTML={{ __html: block.data.js }} />
                    )}
                </div>
            );
        ...
        case 'form':
            ...
            return (
                <div className="form-block">
                    <form 
                        action={block.data?.submitUrl || '/api/contact'} 
                        method="POST"
                        className="space-y-4"
                    >
